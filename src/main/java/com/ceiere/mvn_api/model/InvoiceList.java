...
public class InvoiceList   {
  @JsonProperty("list")
  @Valid
  private List<Invoice> list = null;

  public InvoiceList list(List<Invoice> list) {
    this.list = list;
    return this;
  }

  public InvoiceList addListItem(Invoice listItem) {
    if (this.list == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.list, invoiceList.list);
  }
